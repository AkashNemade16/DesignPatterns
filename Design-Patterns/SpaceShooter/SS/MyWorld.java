...
public class MyWorld extends World {
    ...
    public MyWorld() {
        ...
        setPaintOrder(Information.class, StartScreen.class, Score.class, ScoreBoard.class, SpaceShooter.class, Blocker.class, Lives.class);
        ...
        addObject(new SpaceShooter(), 400, 550);
